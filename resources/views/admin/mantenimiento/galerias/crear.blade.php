    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-default ">
                ...
                <h3 class="card-title">Crear Galerias</h3>
                @if ($errors->any())
                ...
                <form action="{{route('galerias.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <label>Galeria</label>
                                <input type="text" class="form-control" name="galeria" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <textarea name="mapa" id="" cols="30" rows="10" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" id="customRadio3" name="estado" value="1" required>
                    ...
                    <div class="row">
                        <div class="col-12">
                        <a href="{{route('galerias.index')}}" class="btn btn-secondary">Cancel</a>
