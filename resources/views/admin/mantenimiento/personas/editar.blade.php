    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-default ">
                ...
                <h3 class="card-title">Actualizar Restaurante</h3>
                @if ($errors->any())
                                        ...
                                        <div class="tab-pane fade" id="custom-tabs-three-messages" role="tabpanel" aria-labelledby="custom-tabs-three-messages-tab">
                                            <div class="form-group row">
                                                <div class="col-sm-4">
                                                    ...
                                                    {{-- <select name="galeria_id" id="" class="form-control" required>
                                                        @foreach ($galerias as $item)
                                                            <option value="{{$item->id}}" {{$item->id == $user->persona->tienda->galeria_id ? 'selected':''}}>{{$item->galeria}}</option>
                                                        @endforeach
                                                    </select> --}}
