<section class="padding-bottom">
    <div class="card card-deal">
        <div class="col-heading content-body">
         <header class="section-heading">
          <h3 class="section-title">Promociones y ofertas</h3>
       ...
       <div class="col-md col-6">
        <figure class="card-product-grid card-sm">
         <a href="#" class="img-wrap"> 
          <img src="ecom/images/items/3.jpg"> 
         </a>
    ...
    <div class="col-md col-6">
      <figure class="card-product-grid card-sm">
       <a href="#" class="img-wrap"> 
        <img src="ecom/images/items/4.jpg"> 
      </a>
      <div class="text-wrap p-3">
   ...
   <div class="col-md col-6">
    <figure class="card-product-grid card-sm">
     <a href="#" class="img-wrap"> 
      <img src="ecom/images/items/5.jpg"> 
    </a>
    <div class="text-wrap p-3">
   ...
   <div class="col-md col-6">
    <figure class="card-product-grid card-sm">
     <a href="#" class="img-wrap"> 
      <img src="ecom/images/items/6.jpg"> 
    </a>
    <div class="text-wrap p-3">
   ...
   <div class="col-md col-6">
    <figure class="card-product-grid card-sm">
     <a href="#" class="img-wrap"> 
      <img src="ecom/images/items/7.jpg"> 
    </a>
    <div class="text-wrap p-3">
