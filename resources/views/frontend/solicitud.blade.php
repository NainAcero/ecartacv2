<section class="padding-bottom">
    ...
    <div class="row">
        <div class="col-md-8">
    <div class="card-banner banner-quote overlay-gradient" style="background-image: url('ecom/images/banners/banner9.jpg');">
      <div class="card-img-overlay white">
        <h3 class="card-title">Una forma sencilla de enviar solicitudes a proveedores</h3>
    ...
    <div class="card card-body">
        <h4 class="title py-3">Una solicitud, múltiples cotizaciones</h4>
        <form>
